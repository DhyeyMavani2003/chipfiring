...
% Divisor Definition (Graph with Chip Counts)
...
% Degree information as labels
    \node[anchor=west, xshift=1pt, yshift=1pt, at=(Alice.north east), font=\small] {2};
    \node[anchor=west, xshift=1pt, yshift=1pt, at=(Bob.north east), font=\small] {-3};
    \node[anchor=west, xshift=1pt, yshift=1pt, at=(Charlie.north east), font=\small] {4};
    \node[anchor=west, xshift=1pt, yshift=1pt, at=(Elise.north east), font=\small] {-1};
